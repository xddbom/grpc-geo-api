...
const (
	Aggregator_Aggregate_FullMethodName = "/aggregate.v1.Aggregator/Aggregate"
)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregateRequest) (*AggregateResponse, error) {
...
var Aggregator_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aggregate.v1.Aggregator",
	...
	Metadata: "aggregate/v1/aggregate.proto",
}
